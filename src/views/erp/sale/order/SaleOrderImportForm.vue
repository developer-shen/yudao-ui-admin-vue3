...
defineOptions({ name: 'SaleOrderImportForm' })
...
const uploadRef = ref()
const importUrl =
  import.meta.env.VITE_BASE_URL + import.meta.env.VITE_API_URL + '/erp/sale-order/import-excel'
...
const importTemplate = async () => {
  ...
  download.excel(res, '销售订单导入模版.xlsx')
}
</script>
